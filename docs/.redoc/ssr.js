...
var AwaitContextProvider = (props) => React3__namespace.createElement(AwaitContext.Provider, props);
...
var OutletContext = React3__namespace.createContext(null);
function useOutletContext() {
  return React3__namespace.useContext(OutletContext);
}
function useOutlet(context) {
  let outlet = React3__namespace.useContext(RouteContext).outlet;
  if (outlet) {
    return /* @__PURE__ */ React3__namespace.createElement(OutletContext.Provider, { value: context }, outlet);
  }
  return outlet;
}
function useParams() {
...
function useRevalidator() {
  ...
  let revalidate = React3__namespace.useCallback(async () => {
...
function useAsyncValue() {
  let value = React3__namespace.useContext(AwaitContext);
  return value?._data;
}
...
function useBlocker(shouldBlock) {
  ...
  let [blockerKey, setBlockerKey] = React3__namespace.useState("");
  let blockerFunction = React3__namespace.useCallback(
    (arg) => {
...
function mapRouteProperties(route) {
  ...
  if (route.Component) {
    ...
    Object.assign(updates, {
      element: React3__namespace.createElement(route.Component),
      Component: void 0
    });
  }
  if (route.HydrateFallback) {
    ...
    Object.assign(updates, {
      hydrateFallbackElement: React3__namespace.createElement(route.HydrateFallback),
  ...
  if (route.ErrorBoundary) {
    ...
    Object.assign(updates, {
      errorElement: React3__namespace.createElement(route.ErrorBoundary),
...
function RouterProvider({
  ...
  let [state, setStateImpl] = React3__namespace.useState(router2.state);
  let [pendingState, setPendingState] = React3__namespace.useState();
  let [vtContext, setVtContext] = React3__namespace.useState({
    isTransitioning: false
  });
  let [renderDfd, setRenderDfd] = React3__namespace.useState();
  let [transition, setTransition] = React3__namespace.useState();
  let [interruption, setInterruption] = React3__namespace.useState();
  let fetcherData = React3__namespace.useRef(/* @__PURE__ */ new Map());
  let logErrorsAndSetState = React3__namespace.useCallback(
    (newState) => {
  ...
  let setState = React3__namespace.useCallback(
    (newState, { deletedFetchers, flushSync, viewTransitionOpts }) => {
      ...
      if (!viewTransitionOpts || !isViewTransitionAvailable) {
        if (reactDomFlushSyncImpl && flushSync) {
          ...
          React3__namespace.startTransition(() => logErrorsAndSetState(newState));
        }
        return;
      }
      if (reactDomFlushSyncImpl && flushSync) {
  ...
  React3__namespace.useLayoutEffect(() => router2.subscribe(setState), [router2, setState]);
  React3__namespace.useEffect(() => {
  ...
  let navigator = React3__namespace.useMemo(() => {
    return {
  ...
  let dataRouterContext = React3__namespace.useMemo(
    () => ({
      router: router2,
      navigator,
      static: false,
  ...
  return /* @__PURE__ */ React3__namespace.createElement(React3__namespace.Fragment, null, /* @__PURE__ */ React3__namespace.createElement(DataRouterContext.Provider, { value: dataRouterContext }, /* @__PURE__ */ React3__namespace.createElement(DataRouterStateContext.Provider, { value: state }, /* @__PURE__ */ React3__namespace.createElement(FetchersContext.Provider, { value: fetcherData.current }, /* @__PURE__ */ React3__namespace.createElement(ViewTransitionContext.Provider, { value: vtContext }, /* @__PURE__ */ React3__namespace.createElement(
    Router,
    {
      basename,
      location: state.location,
...
var MemoizedDataRoutes = React3__namespace.memo(DataRoutes);
function DataRoutes({
  routes: routes2,
  future,
  state,
...
function MemoryRouter({
  ...
  let historyRef = React3__namespace.useRef();
  ...
  let [state, setStateImpl] = React3__namespace.useState({
    action: history.action,
    location: history.location
  });
  let setState = React3__namespace.useCallback(
    (newState) => {
      React3__namespace.startTransition(() => setStateImpl(newState));
    },
    [setStateImpl]
  );
  React3__namespace.useLayoutEffect(() => history.listen(setState), [history, setState]);
  return /* @__PURE__ */ React3__namespace.createElement(
    Router,
    {
      basename,
...
function Navigate({
  ...
  let { static: isStatic } = React3__namespace.useContext(NavigationContext);
  warning(
    !isStatic,
...
function Router({
  ...
  let navigationContext = React3__namespace.useMemo(
    () => ({
      basename,
      navigator,
      static: staticProp,
  ...
  let locationContext = React3__namespace.useMemo(() => {
  ...
  return /* @__PURE__ */ React3__namespace.createElement(NavigationContext.Provider, { value: navigationContext }, /* @__PURE__ */ React3__namespace.createElement(LocationContext.Provider, { children, value: locationContext }));
}
function Routes({
  children,
  location: location2
...
var AwaitErrorBoundary = class extends React3__namespace.Component {
  constructor(props) {
    super(props);
  ...
  render() {
    ...
    if (status === 2) {
      return /* @__PURE__ */ React3__namespace.createElement(AwaitContext.Provider, { value: promise, children: errorElement });
    }
    if (status === 1) {
      return /* @__PURE__ */ React3__namespace.createElement(AwaitContext.Provider, { value: promise, children });
    }
    throw promise;
  }
};
...
function createRoutesFromChildren(children, parentPath = []) {
  let routes2 = [];
  React3__namespace.Children.forEach(children, (element, index) => {
...
function WithComponentProps({
  ...
  return React3__namespace.cloneElement(children, props);
}
function withComponentProps(Component4) {
  return function WithComponentProps2() {
    const props = useRouteComponentProps();
    return React3__namespace.createElement(Component4, props);
  };
}
...
function withHydrateFallbackProps(HydrateFallback) {
  return function WithHydrateFallbackProps2() {
    const props = useHydrateFallbackProps();
    return React3__namespace.createElement(HydrateFallback, props);
  };
}
...
function withErrorBoundaryProps(ErrorBoundary) {
  return function WithErrorBoundaryProps2() {
    const props = useErrorBoundaryProps();
    return React3__namespace.createElement(ErrorBoundary, props);
  };
}
...
function StreamTransfer({
  ...
  let scriptTag = value ? /* @__PURE__ */ React3__namespace.createElement(
    "script",
    {
      nonce,
  ...
  if (done) {
    return /* @__PURE__ */ React3__namespace.createElement(React3__namespace.Fragment, null, scriptTag, /* @__PURE__ */ React3__namespace.createElement(
      "script",
      {
        nonce,
        dangerouslySetInnerHTML: {
    ...
    return /* @__PURE__ */ React3__namespace.createElement(React3__namespace.Fragment, null, scriptTag, /* @__PURE__ */ React3__namespace.createElement(React3__namespace.Suspense, null, /* @__PURE__ */ React3__namespace.createElement(
      StreamTransfer,
      {
        context,
...
async function fetchAndDecodeViaTurboStream(args, basename, targetRoutes) {
  ...
  if (NO_BODY_STATUS_CODES.has(res.status)) {
    ...
    if (targetRoutes && request.method !== "GET") {
      routes2[targetRoutes[0]] = { data: void 0 };
    }
    return {
      status: res.status,
      data: { routes: routes2 }
...
function RemixRootDefaultHydrateFallback() {
  return /* @__PURE__ */ React3__namespace.createElement(BoundaryShell, { title: "Loading...", renderScripts: true }, /* @__PURE__ */ React3__namespace.createElement(
    "script",
    {
      dangerouslySetInnerHTML: {
        __html: `
...
function getRouteComponents(route, routeModule, isSpaMode) {
  ...
  let ErrorBoundary = routeModule.ErrorBoundary ? routeModule.ErrorBoundary : route.id === "root" ? () => /* @__PURE__ */ React3__namespace.createElement(RemixRootDefaultErrorBoundary, { error: useRouteError() }) : void 0;
...
function Links({ nonce }) {
  ...
  let keyedLinks = React3__namespace.useMemo(
    () => getKeyedLinksForMatches(matches, routeModules, manifest),
    [matches, routeModules, manifest]
  );
  return /* @__PURE__ */ React3__namespace.createElement(React3__namespace.Fragment, null, typeof criticalCss === "string" ? /* @__PURE__ */ React3__namespace.createElement(
    "style",
    {
      ...{ [CRITICAL_CSS_DATA_ATTRIBUTE]: "" },
      dangerouslySetInnerHTML: { __html: criticalCss }
    }
  ) : null, typeof criticalCss === "object" ? /* @__PURE__ */ React3__namespace.createElement(
    "link",
    {
      ...{ [CRITICAL_CSS_DATA_ATTRIBUTE]: "" },
      rel: "stylesheet",
    ...
    ({ key, link }) => isPageLinkDescriptor(link) ? /* @__PURE__ */ React3__namespace.createElement(PrefetchPageLinks, { key, nonce, ...link }) : /* @__PURE__ */ React3__namespace.createElement("link", { key, nonce, ...link })
  ));
}
...
function Meta() {
  ...
  return /* @__PURE__ */ React3__namespace.createElement(React3__namespace.Fragment, null, meta.flat().map((metaProps) => {
    if (!metaProps) {
      return null;
    }
    if ("tagName" in metaProps) {
      ...
      let Comp = tagName;
      return /* @__PURE__ */ React3__namespace.createElement(Comp, { key: JSON.stringify(rest), ...rest });
    }
    if ("title" in metaProps) {
      return /* @__PURE__ */ React3__namespace.createElement("title", { key: "title" }, String(metaProps.title));
    }
    ...
    if ("charSet" in metaProps && metaProps.charSet != null) {
      return typeof metaProps.charSet === "string" ? /* @__PURE__ */ React3__namespace.createElement("meta", { key: "charSet", charSet: metaProps.charSet }) : null;
    }
    ...
    return /* @__PURE__ */ React3__namespace.createElement("meta", { key: JSON.stringify(metaProps), ...metaProps });
  }));
}
...
function Scripts(scriptProps) {
  ...
  let initialScripts = React3__namespace.useMemo(() => {
...
import(${JSON.stringify(manifest.entry.module)});`;
  ...
  return isHydrated || isRSCRouterContext ? null : /* @__PURE__ */ React3__namespace.createElement(React3__namespace.Fragment, null, typeof manifest.sri === "object" ? /* @__PURE__ */ React3__namespace.createElement(
    "script",
    {
      "rr-importmap": "",
      type: "importmap",
  ...
  ) : null, !enableFogOfWar ? /* @__PURE__ */ React3__namespace.createElement(
    "link",
    {
      rel: "modulepreload",
      href: manifest.url,
  ...
  ) : null, /* @__PURE__ */ React3__namespace.createElement(
    "link",
    {
      rel: "modulepreload",
  ...
  ), preloads.map((path) => /* @__PURE__ */ React3__namespace.createElement(
    "link",
    {
      key: path,
      rel: "modulepreload",
...
var RemixErrorBoundary = class extends React3__namespace.Component {
  constructor(props) {
    super(props);
...
function RemixRootDefaultErrorBoundary({
  ...
  console.error(error);
  let heyDeveloper = /* @__PURE__ */ React3__namespace.createElement(
    "script",
    {
      dangerouslySetInnerHTML: {
        __html: `
  ...
  if (isRouteErrorResponse(error)) {
    return /* @__PURE__ */ React3__namespace.createElement(BoundaryShell, { title: "Unhandled Thrown Response!" }, /* @__PURE__ */ React3__namespace.createElement("h1", { style: { fontSize: "24px" } }, error.status, " ", error.statusText), heyDeveloper);
  }
  let errorInstance;
  ...
  return /* @__PURE__ */ React3__namespace.createElement(
    ...
    /* @__PURE__ */ React3__namespace.createElement("h1", { style: { fontSize: "24px" } }, "Application Error"),
    /* @__PURE__ */ React3__namespace.createElement(
      "pre",
      {
        style: {
...
function BoundaryShell({
  ...
  return /* @__PURE__ */ React3__namespace.createElement("html", { lang: "en" }, /* @__PURE__ */ React3__namespace.createElement("head", null, /* @__PURE__ */ React3__namespace.createElement("meta", { charSet: "utf-8" }), /* @__PURE__ */ React3__namespace.createElement(
    "meta",
    {
      name: "viewport",
      content: "width=device-width,initial-scale=1,viewport-fit=cover"
    }
  ), /* @__PURE__ */ React3__namespace.createElement("title", null, title)), /* @__PURE__ */ React3__namespace.createElement("body", null, /* @__PURE__ */ React3__namespace.createElement("main", { style: { fontFamily: "system-ui, sans-serif", padding: "2rem" } }, children, renderScripts ? /* @__PURE__ */ React3__namespace.createElement(Scripts, null) : null)));
}
...
var Link = React3__namespace.forwardRef(
  function LinkWithRef({
    ...
    return shouldPrefetch && !isAbsolute ? /* @__PURE__ */ React3__namespace.createElement(React3__namespace.Fragment, null, link, /* @__PURE__ */ React3__namespace.createElement(PrefetchPageLinks, { page: href2 })) : link;
  }
);
...
function ScrollRestoration({
  ...
  let remixContext = React3__namespace.useContext(FrameworkContext);
  let { basename } = React3__namespace.useContext(NavigationContext);
  let location2 = useLocation();
  let matches = useMatches();
  useScrollRestoration({ getKey, storageKey });
  let ssrKey = React3__namespace.useMemo(
    () => {
...
function useSearchParams(defaultInit) {
  ...
  let defaultSearchParamsRef = React3__namespace.useRef(createSearchParams(defaultInit));
  let hasSetSearchParamsRef = React3__namespace.useRef(false);
  let location2 = useLocation();
  let searchParams = React3__namespace.useMemo(
    () => (
  ...
  let navigate = useNavigate();
  let setSearchParams = React3__namespace.useCallback(
...
function useFetcher({
  ...
  let fetcherData = React3__namespace.useContext(FetchersContext);
  let route = React3__namespace.useContext(RouteContext);
  ...
  let defaultKey = React3__namespace.useId();
  let [fetcherKey, setFetcherKey] = React3__namespace.useState(key || defaultKey);
  ...
  let load = React3__namespace.useCallback(
    async (href2, opts) => {
  ...
  let submit = React3__namespace.useCallback(
    async (target, opts) => {
  ...
  let FetcherForm = React3__namespace.useMemo(() => {
    let FetcherForm2 = React3__namespace.forwardRef(
      (props, ref) => {
        return /* @__PURE__ */ React3__namespace.createElement(Form, { ...props, navigate: false, fetcherKey, ref });
      }
    );
  ...
  let fetcherWithComponents = React3__namespace.useMemo(
    () => ({
      Form: FetcherForm,
      submit,
      load,
...
function StaticRouterProvider({
  ...
  return /* @__PURE__ */ React3__namespace.createElement(React3__namespace.Fragment, null, /* @__PURE__ */ React3__namespace.createElement(DataRouterContext.Provider, { value: dataRouterContext }, /* @__PURE__ */ React3__namespace.createElement(DataRouterStateContext.Provider, { value: state }, /* @__PURE__ */ React3__namespace.createElement(FetchersContext.Provider, { value: fetchersContext }, /* @__PURE__ */ React3__namespace.createElement(ViewTransitionContext.Provider, { value: { isTransitioning: false } }, /* @__PURE__ */ React3__namespace.createElement(
    Router,
    {
  ...
  ))))), hydrateScript ? /* @__PURE__ */ React3__namespace.createElement(
    "script",
    {
      suppressHydrationWarning: true,
      nonce,
...
function DataRoutes2({
  ...
  return useRoutesImpl(routes2, void 0, state, void 0, future);
}
...
function ServerRouter({
  ...
  let router2 = createStaticRouter(routes2, context.staticHandlerContext);
  return /* @__PURE__ */ React3__namespace.createElement(React3__namespace.Fragment, null, /* @__PURE__ */ React3__namespace.createElement(
    ...
    /* @__PURE__ */ React3__namespace.createElement(RemixErrorBoundary, { location: router2.state.location }, /* @__PURE__ */ React3__namespace.createElement(
  ...
  ), context.serverHandoffStream ? /* @__PURE__ */ React3__namespace.createElement(React3__namespace.Suspense, null, /* @__PURE__ */ React3__namespace.createElement(
    StreamTransfer,
    {
      context,
      identifier: 0,
...
function createRoutesStub(routes2, _context) {
  return function RoutesTestStub({
    ...
    let routerRef = React3__namespace.useRef();
    let frameworkContextRef = React3__namespace.useRef();
    ...
    return /* @__PURE__ */ React3__namespace.createElement(FrameworkContext.Provider, { value: frameworkContextRef.current }, /* @__PURE__ */ React3__namespace.createElement(RouterProvider, { router: routerRef.current }));
  };
}
...
var createRequestHandler = (build, mode) => {
  ...
  return async function requestHandler(request, initialContext) {
    ...
    let matches = matchServerRoutes(routes2, normalizedPath, _build.basename);
...
function getHydrationData({
  ...
  let initialMatches = matchRoutes(routes2, location2, basename);
  if (initialMatches) {
...
function createRouterFromPayload({
  ...
  let routes2 = payload.matches.reduceRight((previous, match) => {
  ...
  globalVar.__reactRouterDataRouter._updateRoutesForHMR = (routeUpdateByRouteId) => {
    ...
    const newRoutes = [];
    function walkRoutes(routes22, parentId) {
      return routes22.map((route) => {
...
function RSCHydratedRouter({
  ...
  if (payload.type !== "render") throw new Error("Invalid payload type");
  let { router: router2, routeModules } = React3__namespace.useMemo(
  ...
  let [location2, setLocation] = React3__namespace.useState(router2.state.location);
  React3__namespace.useLayoutEffect(
  ...
  return /* @__PURE__ */ React3__namespace.createElement(RSCRouterContext.Provider, { value: true }, /* @__PURE__ */ React3__namespace.createElement(RSCRouterGlobalErrorBoundary, { location: location2 }, /* @__PURE__ */ React3__namespace.createElement(FrameworkContext.Provider, { value: frameworkContext }, /* @__PURE__ */ React3__namespace.createElement(RouterProvider, { router: router2, flushSync: ReactDOM__namespace.flushSync }))));
}
...
function RSCStaticRouter({ getPayload }) {
  ...
  return /* @__PURE__ */ React3__namespace.createElement(RSCRouterContext.Provider, { value: true }, /* @__PURE__ */ React3__namespace.createElement(RSCRouterGlobalErrorBoundary, { location: payload.location }, /* @__PURE__ */ React3__namespace.createElement(FrameworkContext.Provider, { value: frameworkContext }, /* @__PURE__ */ React3__namespace.createElement(
    StaticRouterProvider,
    {
      context,
      router: router2,
...
function RouterProvider2(props) {
  return /* @__PURE__ */ React3__namespace.createElement(RouterProvider, { flushSync: ReactDOM__namespace.flushSync, ...props });
}
var ssrInfo = null;
var router = null;
...
function createHydratedRouter({
  ...
  let routes2 = createClientRoutes(
...
function HydratedRouter(props) {
  ...
  let [criticalCss, setCriticalCss] = React3__namespace.useState(
  ...
  let [location2, setLocation] = React3__namespace.useState(router.state.location);
  React3__namespace.useLayoutEffect(() => {
  ...
  return (
    ...
    /* @__PURE__ */ React3__namespace.createElement(React3__namespace.Fragment, null, /* @__PURE__ */ React3__namespace.createElement(
      FrameworkContext.Provider,
      {
        value: {
      ...
      /* @__PURE__ */ React3__namespace.createElement(RemixErrorBoundary, { location: location2 }, /* @__PURE__ */ React3__namespace.createElement(
        RouterProvider2,
        {
          router,
...
function requireDist() {
  ...
  (function(module2) {
    ...
    __reExport(index_exports, require$$1, module2.exports);
  })(dist$1);
  return dist$1.exports;
}
var distExports = /* @__PURE__ */ requireDist();
function About() {
  return /* @__PURE__ */ jsxRuntime.jsx("div", { children: "About" });
}
function Resume() {
  return /* @__PURE__ */ jsxRuntime.jsx("div", { children: "Resume" });
}
function Index() {
...
function _createMdxContent(props) {
  ...
  return jsxRuntime.jsxs(jsxRuntime.Fragment, {
    children: [jsxRuntime.jsxs(_components.h1, {
    ...
    }), "\n", jsxRuntime.jsxs(_components.h4, {
      id: "四级标题",
      children: [jsxRuntime.jsx(_components.a, {
        className: "header-anchor",
        href: "#四级标题",
    ...
    }), "\n", jsxRuntime.jsxs(_components.h5, {
      id: "五级标题",
      children: [jsxRuntime.jsx(_components.a, {
        className: "header-anchor",
        href: "#五级标题",
    ...
    }), "\n", jsxRuntime.jsxs(_components.h6, {
      id: "六级标题",
      children: [jsxRuntime.jsx(_components.a, {
        className: "header-anchor",
        href: "#六级标题",
      ...
      children: [jsxRuntime.jsx(_components.strong, {
        children: "粗体文本"
      }), " 和 ", jsxRuntime.jsx(_components.em, {
        children: "斜体文本"
      })]
    }), "\n", jsxRuntime.jsx(_components.p, {
      children: jsxRuntime.jsx(_components.em, {
        children: jsxRuntime.jsx(_components.strong, {
          children: "粗斜体文本"
        })
      })
    ...
    }), "\n", jsxRuntime.jsxs(_components.blockquote, {
      children: ["\n", jsxRuntime.jsx(_components.p, {
        children: "这是一个引用"
      }), "\n", jsxRuntime.jsx(_components.p, {
        children: "多行引用示例"
      ...
      children: ["行内代码 ", jsxRuntime.jsx(_components.code, {
      ...
      children: [jsxRuntime.jsx(_components.span, {
        ...
        children: jsxRuntime.jsx(_components.pre, {
          className: "shiki shiki-themes vitesse-dark vitesse-dark",
          style: {
      ...
      children: [jsxRuntime.jsx(_components.thead, {
      ...
      }), jsxRuntime.jsxs(_components.tbody, {
        children: [jsxRuntime.jsxs(_components.tr, {
        ...
        }), jsxRuntime.jsxs(_components.tr, {
          children: [jsxRuntime.jsx(_components.td, {
            children: "示例文本"
          }), jsxRuntime.jsx(_components.td, {
            children: "示例文本"
      ...
      children: "使用 KaTeX 或 MathJax 渲染数学公式（需要相应配置）："
    }), "\n", jsxRuntime.jsxs(_components.p, {
      children: ["行内公式：", jsxRuntime.jsx(_components.code, {
        children: "$E = mc^2$"
      })]
    }), "\n", jsxRuntime.jsx(_components.p, {
      children: "块级公式："
      ...
      children: ["这是一个带有脚注的文本", jsxRuntime.jsx(_components.sup, {
        children: jsxRuntime.jsx(_components.a, {
      ...
      children: [jsxRuntime.jsxs(_components.h2, {
        ...
        children: ["\n", jsxRuntime.jsxs(_components.li, {
          ...
          children: ["\n", jsxRuntime.jsxs(_components.p, {
            children: ["这是脚注的内容 ", jsxRuntime.jsx(_components.a, {
...
const routes = [
  { path: "/about/", element: React3.createElement(About) },
  { path: "/about/resume", element: React3.createElement(Resume) },
  { path: "/", element: React3.createElement(Index) },
  { path: "/intro", element: React3.createElement(MDXContent$1) },
  { path: "/markdown-template", element: React3.createElement(MDXContent) }
];
const Routers = () => {
  const routeElement = distExports.useRoutes(routes);
  return routeElement;
};
function Layout() {
  const [state, setState] = React3.useState(0);
  return /* @__PURE__ */ jsxRuntime.jsxs("div", { children: [
    /* @__PURE__ */ jsxRuntime.jsxs("div", { children: [
      state,
      " - button"
    ] }),
    /* @__PURE__ */ jsxRuntime.jsx("button", { onClick: () => setState(state + 1), children: "+ 1" }),
    /* @__PURE__ */ jsxRuntime.jsx(Routers, {})
  ] });
}
function App() {
...
function render(pagePath) {
  return server.renderToString(
    /* @__PURE__ */ jsxRuntime.jsx(distExports.StaticRouter, { location: pagePath, children: /* @__PURE__ */ jsxRuntime.jsx(App, {}) })
  );
}
